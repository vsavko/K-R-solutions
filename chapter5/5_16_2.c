...
void qsort1(void *lineptr[], int left, int right, int (*comp)(void *, void *), int, int);
...
main(int argc, char *argv[])
{
	...
	if ((nlines = readlines(lineptr, MAXLINES)) >= 0) {
			...
			qsort1((void **) lineptr, 0, nlines-1,(int (*)(void*,void*))(numeric ? numcmp : strcmp ), sort2, limit);
...
void qsort1(void *v[], int left, int right, int (*comp)(void *, void *), int ascending, int limit)
{
	int i, last, j, z;
	...
	qsort1(v, left, last-1, comp, ascending, limit);
	qsort1(v, last+1, right, comp, ascending, limit);
}
